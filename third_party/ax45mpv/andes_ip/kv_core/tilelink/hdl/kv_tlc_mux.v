...
generate
    if (BEAT_CNT_WIDTH > 1) begin:gen_beat_cnt_width_gt_1
        assign a_last_cnt_inc = a_last_cnt + {{BEAT_CNT_WIDTH - 1{1'b0}},1'b1};
        assign c_last_cnt_inc = c_last_cnt + {{BEAT_CNT_WIDTH - 1{1'b0}},1'b1};
    end
    else begin:gen_beat_cnt_with_1
        assign a_last_cnt_inc = a_last_cnt + 1'b1;
        assign c_last_cnt_inc = c_last_cnt + 1'b1;
    end
endgenerate
