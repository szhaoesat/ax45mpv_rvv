...
wire s54;
wire s55;
wire [DS_COUNT_MSB:0] s56;
wire s57;
wire s58;
wire s59;
wire s60;
assign s53 = div_enable | sqrt_enable;
wire s61 = (s43 != DS_ST_IDLE) | s53 | ds_invalidate;
...
assign nds_unused_init_state = (s43 == DS_ST_INIT);
assign s51 = (s43 == DS_ST_CALC);
assign s52 = (s43 == DS_ST_DONE);
assign s54 = s53 & (s50 | s52);
assign s10 = div_enable & (s50 | s52);
always @(posedge vpu_vfdiv_clk or negedge vpu_reset_n) begin
    if (!vpu_reset_n) begin
...
assign s58 = s59 & s51;
assign s59 = (s46 == 2'b10) ? (s48 == 5'd06) : (s46 == 2'b11) ? (s48 == 5'd06) : (s46 == 2'b01) ? (s48 == 5'd13) : (s48 == 5'd27);
assign s57 = s54 | (!s59 & s51);
assign s56 = s51 ? s47 + {{DS_COUNT_MSB{1'b0}},1'b1} : {{(DS_COUNT_WIDTH - 1){1'b0}},sqrt_enable};
always @(posedge vpu_vfdiv_clk or negedge vpu_reset_n) begin
    if (!vpu_reset_n) begin
...
wire [6:0] s62;
assign s62 = {6'd0,s22};
wire [1:0] nds_unused_qrst_index_y_co;
assign {nds_unused_qrst_index_y_co,s21} = s23 + s24 + s62;
assign s60 = (s48 == 5'd1);
assign s18 = s60 ? 3'b101 : s4[54] ? 3'b111 : s4[52:50];
...
assign s11 = s54 | s51 & (!s59 | !f3_stall);
always @(posedge vpu_vfdiv_clk or negedge vpu_reset_n) begin
    if (!vpu_reset_n) begin
        s2 <= {DS_QR_WIDTH{1'b0}};
    end
...
assign ds_gen_sticky = s52;
assign ds_calc_done = s58;
...
wire nds_unused_partially_used_wires = |s1 | (|s27) | (|s28) | (|s42);
generate
    if (FLEN == 16) begin:gen_fpu_dsu_hp
        ...
        assign ds_result0 = s58 ? s41[DS_DOUT_MSB:0] : !s52 ? {DS_DOUT_WIDTH{1'b0}} : (s46 == 2'b11) ? {5'd0,s4[54:45],1'b0} : {2'd0,s4[54:42],1'b0};
        assign ds_result1 = s58 ? {s42[(DS_DOUT_MSB - 1):0],1'b0} : !s52 ? {DS_DOUT_WIDTH{1'b0}} : (s46 == 2'b11) ? {5'd0,s5[54:45],1'b0} : {2'd0,s5[54:42],1'b0};
    end
        ...
        assign ds_result0 = s58 ? s41[DS_DOUT_MSB:0] : !s52 ? {DS_DOUT_WIDTH{1'b0}} : (s46 == 2'b11) ? {18'd0,s4[54:45],1'b0} : (s46 == 2'b10) ? {15'd0,s4[54:42],1'b0} : {02'd0,s4[54:29],1'b0};
        assign ds_result1 = s58 ? {s42[(DS_DOUT_MSB - 1):0],1'b0} : !s52 ? {DS_DOUT_WIDTH{1'b0}} : (s46 == 2'b11) ? {18'd0,s5[54:45],1'b0} : (s46 == 2'b10) ? {15'd0,s5[54:42],1'b0} : {02'd0,s5[54:29],1'b0};
    end
        ...
        assign s31 = s29;
        assign s32 = s30;
        assign ds_result0 = s58 ? s41[DS_DOUT_MSB:0] : !s52 ? {DS_DOUT_WIDTH{1'b0}} : (s46 == 2'b11) ? {47'd0,s4[54:45],1'b0} : (s46 == 2'b10) ? {44'd0,s4[54:42],1'b0} : (s46 == 2'b01) ? {31'd0,s4[54:29],1'b0} : {2'd0,s4[54:0],1'b0};
        assign ds_result1 = s58 ? {s42[(DS_DOUT_MSB - 1):0],1'b0} : !s52 ? {DS_DOUT_WIDTH{1'b0}} : (s46 == 2'b11) ? {47'd0,s5[54:45],1'b0} : (s46 == 2'b10) ? {44'd0,s5[54:42],1'b0} : (s46 == 2'b01) ? {31'd0,s5[54:29],1'b0} : {2'd0,s5[54:0],1'b0};
    end
endgenerate
`ifndef NDS_FPGA
