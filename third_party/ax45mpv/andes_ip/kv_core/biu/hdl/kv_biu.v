...
wire s0;
wire [BIU_ID_WIDTH - 1:0] s1;
wire [BIU_ID_WIDTH - 1:0] s2;
wire [BIU_ID_WIDTH - 1:0] s3;
wire s4;
...
wire ds_d_valid;
wire ds_e_ready;
wire [(BIU_ADDR_WIDTH - 1):0] nds_unused_ds_b_address;
wire nds_unused_ds_b_corrupt;
wire [(BIU_DATA_WIDTH - 1):0] nds_unused_ds_b_data;
wire [BIU_DATA_WIDTH / 8 - 1:0] nds_unused_ds_b_mask;
wire [2:0] nds_unused_ds_b_opcode;
wire [2:0] nds_unused_ds_b_param;
wire [2:0] nds_unused_ds_b_size;
wire [(BIU_ID_WIDTH - 1):0] nds_unused_ds_b_source;
...
wire s83;
wire [BIU_ID_WIDTH - 1:0] s84;
wire [TL_D_USER_WIDTH - 1:0] s85;
wire s86;
wire [0:0] nds_unused_i_aruser;
wire [0:0] nds_unused_i_awuser;
wire [0:0] nds_unused_i_wuser;
wire [(BIU_ADDR_WIDTH - 1):0] nds_unused_icu_b_address;
wire nds_unused_icu_b_corrupt;
wire [(BIU_DATA_WIDTH - 1):0] nds_unused_icu_b_data;
wire [BIU_DATA_WIDTH / 8 - 1:0] nds_unused_icu_b_mask;
wire [2:0] nds_unused_icu_b_opcode;
wire [2:0] nds_unused_icu_b_param;
wire [2:0] nds_unused_icu_b_size;
wire [(BIU_ID_WIDTH - 1):0] nds_unused_icu_b_source;
wire nds_unused_icu_b_user;
wire nds_unused_icu_b_valid;
wire [(BIU_ADDR_WIDTH * 3) - 1:0] nds_unused_x1_b_address;
wire [2:0] nds_unused_x1_b_corrupt;
wire [(BIU_DATA_WIDTH * 3) - 1:0] nds_unused_x1_b_data;
wire [(BIU_DATA_WIDTH * 3 / 8) - 1:0] nds_unused_x1_b_mask;
wire [8:0] nds_unused_x1_b_opcode;
wire [8:0] nds_unused_x1_b_param;
wire [8:0] nds_unused_x1_b_size;
wire [(BIU_ID_WIDTH * 3) - 1:0] nds_unused_x1_b_source;
wire [(TL_B_USER_WIDTH * 3) - 1:0] nds_unused_x1_b_user;
wire [2:0] nds_unused_x1_b_valid;
wire [2:0] s87;
wire [2:0] s88;
wire [2:0] s89;
wire [(BIU_DATA_WIDTH * 3) - 1:0] s90;
wire [2:0] s91;
wire [8:0] s92;
wire [5:0] s93;
wire [(TL_SINK_WIDTH * 3) - 1:0] s94;
wire [8:0] s95;
wire [(BIU_ID_WIDTH * 3) - 1:0] s96;
wire [(TL_D_USER_WIDTH * 3) - 1:0] s97;
wire [2:0] s98;
wire [2:0] s99;
...
wire [(BIU_ADDR_WIDTH * 2) - 1:0] nds_unused_x2_b_address;
wire [1:0] nds_unused_x2_b_corrupt;
wire [(BIU_DATA_WIDTH * 2) - 1:0] nds_unused_x2_b_data;
wire [(BIU_DATA_WIDTH * 2 / 8) - 1:0] nds_unused_x2_b_mask;
wire [5:0] nds_unused_x2_b_opcode;
wire [5:0] nds_unused_x2_b_param;
wire [5:0] nds_unused_x2_b_size;
wire [(BIU_ID_WIDTH * 2) - 1:0] nds_unused_x2_b_source;
wire [(TL_B_USER_WIDTH * 2) - 1:0] nds_unused_x2_b_user;
wire [1:0] nds_unused_x2_b_valid;
wire [1:0] s100;
wire [1:0] s101;
wire [1:0] s102;
wire [(BIU_DATA_WIDTH * 2) - 1:0] s103;
wire [1:0] s104;
wire [5:0] s105;
wire [3:0] s106;
wire [(TL_SINK_WIDTH * 2) - 1:0] s107;
wire [5:0] s108;
wire [(BIU_ID_WIDTH * 2) - 1:0] s109;
wire [(TL_D_USER_WIDTH * 2) - 1:0] s110;
wire [1:0] s111;
wire [1:0] s112;
generate
...
generate
    if ((BIU_PATH_X2_INT == 0)) begin:gen_x1_tls
        ...
        assign {icu_a_ready,dcu_a_ready,lsu_a_ready} = s87;
        ...
        assign {s83,dcu_c_ready,s26} = s88;
        assign {icu_d_opcode,dcu_d_opcode,lsu_d_opcode} = s92;
        assign {icu_d_param,dcu_d_param,lsu_d_param} = s93;
        assign {icu_d_size,dcu_d_size,lsu_d_size} = s95;
        assign s85 = s97[6 +:3];
        assign dcu_d_user = {4'b0,s97[3 +:2]};
        assign lsu_d_xresp = s97[0 +:2];
        assign {icu_d_data,dcu_d_data,lsu_d_data} = s90;
        assign {s84,s3,s31} = s96;
        assign {icu_d_sink,dcu_d_sink,lsu_d_sink} = s94;
        assign {icu_d_denied,dcu_d_denied,lsu_d_denied} = s91;
        assign {icu_d_corrupt,dcu_d_corrupt,lsu_d_corrupt} = s89;
        assign {icu_d_valid,dcu_d_valid,lsu_d_valid} = s98;
        assign s55 = {icu_d_ready,dcu_d_ready,lsu_d_ready};
        assign s58 = {s19,dcu_e_valid,s35};
        assign {s86,dcu_e_ready,s32} = s99;
        ...
        assign s66 = {2 * BIU_ID_WIDTH{1'b0}};
        ...
        assign s75 = {2 * BIU_ID_WIDTH{1'b0}};
        assign s71 = {2 * BIU_DATA_WIDTH{1'b0}};
        assign s70 = {2{1'b0}};
        assign s77 = {2{1'b0}};
        assign s101 = {2{1'b0}};
        assign s105 = {2{3'b0}};
        assign s109 = {2 * BIU_ID_WIDTH{1'b0}};
        assign s106 = {2{2'b0}};
        assign s108 = {2{3'b0}};
        assign s103 = {2 * BIU_DATA_WIDTH{1'b0}};
        assign s102 = {2{1'b0}};
        assign s104 = {2{1'b0}};
        assign s107 = {2 * TL_SINK_WIDTH{1'b0}};
        assign s110 = {2 * TL_D_USER_WIDTH{1'b0}};
        assign s111 = {2{1'b0}};
        assign s78 = {2{1'b0}};
        assign s81 = {2{1'b0}};
        assign s112 = {2{1'b0}};
...
generate
    if ((BIU_PATH_X2_INT == 1)) begin:gen_x2_tls
        ...
        assign {dcu_a_ready,lsu_a_ready} = s100;
        ...
        assign {dcu_c_ready,s26} = s101;
        assign {dcu_d_opcode,lsu_d_opcode} = s105;
        assign {dcu_d_param,lsu_d_param} = s106;
        assign {dcu_d_size,lsu_d_size} = s108;
        assign dcu_d_user = {4'd0,s110[3 +:2]};
        assign lsu_d_xresp = s110[0 +:2];
        assign {dcu_d_data,lsu_d_data} = s103;
        assign {s3,s31} = s109;
        assign {dcu_d_sink,lsu_d_sink} = s107;
        assign {dcu_d_denied,lsu_d_denied} = s104;
        assign {dcu_d_corrupt,lsu_d_corrupt} = s102;
        assign {dcu_d_valid,lsu_d_valid} = s111;
        assign s78 = {dcu_d_ready,lsu_d_ready};
        assign s81 = {dcu_e_valid,s35};
        assign {dcu_e_ready,s32} = s112;
        ...
        assign s43 = {3 * BIU_ID_WIDTH{1'b0}};
        ...
        assign s52 = {3 * BIU_ID_WIDTH{1'b0}};
        ...
        assign s93 = {3{2'b0}};
        assign s95 = {3{3'b0}};
        assign s97 = {3 * TL_D_USER_WIDTH{1'b0}};
        assign s90 = {3 * BIU_DATA_WIDTH{1'b0}};
        assign s96 = {3 * BIU_ID_WIDTH{1'b0}};
        assign s94 = {3 * TL_SINK_WIDTH{1'b0}};
        assign s91 = {3{1'b0}};
        assign s89 = {3{1'b0}};
        assign s98 = {3{1'b0}};
        assign s55 = {3{1'b0}};
...
endgenerate
assign ds_b_sel = 3'b010;
generate
    if (LSU_SOURCE_WIDTH <= 2) begin:gen_lsu_id2
        assign s20 = {{(BIU_ID_WIDTH - LSU_SOURCE_WIDTH){1'b0}},lsu_a_source};
        assign lsu_d_source = s31[LSU_SOURCE_WIDTH - 1:0];
        assign s5 = {2'b01,icu_a_source[1:0]};
        assign icu_d_source = s84[1:0];
        assign s1 = {1'b1,dcu_a_source};
        assign s2 = {1'b1,dcu_c_source};
        assign dcu_d_source = s3[2:0];
        assign ds_d_sel[0] = ds_d_source[3:2] == 2'd0;
        assign ds_d_sel[1] = ds_d_source[3];
        assign ds_d_sel[2] = ds_d_source[3:2] == 2'd1;
    end
    else if (LSU_SOURCE_WIDTH == 3) begin:gen_lsu_id3
        assign s20 = {2'b10,lsu_a_source[2:0]};
        assign lsu_d_source = s31[2:0];
        assign s5 = {3'b001,icu_a_source[1:0]};
        assign icu_d_source = s84[1:0];
        assign s1 = {2'b01,dcu_a_source};
        assign s2 = {2'b01,dcu_c_source};
        assign dcu_d_source = s3[2:0];
        assign ds_d_sel[0] = ds_d_source[4] == 1'd1;
        assign ds_d_sel[1] = ds_d_source[4:3] == 2'd1;
        assign ds_d_sel[2] = ds_d_source[4:3] == 2'd0;
    end
    else if (LSU_SOURCE_WIDTH == 4) begin:gen_lsu_id4
        assign s20 = {1'b1,lsu_a_source[3:0]};
        assign lsu_d_source = s31[3:0];
        assign s5 = {3'b001,icu_a_source[1:0]};
        assign icu_d_source = s84[1:0];
        assign s1 = {2'b01,dcu_a_source};
        assign s2 = {2'b01,dcu_c_source};
    ...
    else if (LSU_SOURCE_WIDTH == 5) begin:gen_lsu_id4
        assign s20 = {1'b1,lsu_a_source[4:0]};
        assign lsu_d_source = s31[4:0];
        assign s5 = {4'b0001,icu_a_source[1:0]};
        assign icu_d_source = s84[1:0];
        assign s1 = {3'b001,dcu_a_source};
        assign s2 = {3'b001,dcu_c_source};
        assign dcu_d_source = s3[2:0];
        assign ds_d_sel[0] = ds_d_source[5] == 1'd1;
        assign ds_d_sel[1] = ds_d_source[5:3] == 3'd1;
        assign ds_d_sel[2] = ds_d_source[5:3] == 3'd0;
    end
endgenerate
assign s6 = {1'b0,icu_a_user};
assign s15 = {1'b0,s14[7:0]};
assign icu_d_xresp = s85[1:0];
generate
...
generate
    if ((BIU_PATH_X2_INT == 0)) begin:gen_biu_x1_unused
        ...
        wire [(BIU_ID_WIDTH - 1):0] nds_unused_i_bid = i_bid;
        wire [1:0] nds_unused_i_bresp = i_bresp;
        wire nds_unused_i_bvalid = i_bvalid;
        wire [(BIU_DATA_WIDTH - 1):0] nds_unused_i_rdata = i_rdata;
        wire [(BIU_ID_WIDTH - 1):0] nds_unused_i_rid = i_rid;
        ...
        wire [(BIU_ID_WIDTH - 1):0] nds_unused_d_bid = d_bid;
        wire [1:0] nds_unused_d_bresp = d_bresp;
        wire nds_unused_d_bvalid = d_bvalid;
        wire [(BIU_DATA_WIDTH - 1):0] nds_unused_d_rdata = d_rdata;
        wire [(BIU_ID_WIDTH - 1):0] nds_unused_d_rid = d_rid;
        ...
        wire [(BIU_ADDR_WIDTH * 2) - 1:0] nds_unused_x2_a_addresses = s59;
        wire [1:0] nds_unused_x2_a_corrupts = s60;
        wire [(BIU_DATA_WIDTH * 2) - 1:0] nds_unused_x2_a_datas = s61;
        wire [(BIU_DATA_WIDTH * 2 / 8) - 1:0] nds_unused_x2_a_masks = s62;
        wire [5:0] nds_unused_x2_a_opcodes = s63;
        wire [5:0] nds_unused_x2_a_params = s64;
        wire [5:0] nds_unused_x2_a_sizes = s65;
        wire [(BIU_ID_WIDTH * 2) - 1:0] nds_unused_x2_a_sources = s66;
        wire [(TL_A_USER_WIDTH * 2) - 1:0] nds_unused_x2_a_users = s67;
        wire [1:0] nds_unused_x2_a_valids = s68;
        wire [(BIU_ADDR_WIDTH * 2) - 1:0] nds_unused_x2_c_addresses = s69;
        wire [1:0] nds_unused_x2_c_corrupts = s70;
        wire [(BIU_DATA_WIDTH * 2) - 1:0] nds_unused_x2_c_datas = s71;
        wire [5:0] nds_unused_x2_c_opcodes = s72;
        wire [5:0] nds_unused_x2_c_params = s73;
        wire [5:0] nds_unused_x2_c_sizes = s74;
        wire [(BIU_ID_WIDTH * 2) - 1:0] nds_unused_x2_c_sources = s75;
        wire [(TL_C_USER_WIDTH * 2) - 1:0] nds_unused_x2_c_users = s76;
        wire [1:0] nds_unused_x2_c_valids = s77;
        wire [1:0] nds_unused_x2_d_readys = s78;
        wire [(TL_SINK_WIDTH * 2) - 1:0] nds_unused_x2_e_sinks = s79;
        wire [(TL_E_USER_WIDTH * 2) - 1:0] nds_unused_x2_e_users = s80;
        wire [1:0] nds_unused_x2_e_valids = s81;
        wire [1:0] nds_unused_x2_a_readys = s100;
        wire [1:0] nds_unused_x2_c_readys = s101;
        wire [1:0] nds_unused_x2_d_corrupts = s102;
        wire [(BIU_DATA_WIDTH * 2) - 1:0] nds_unused_x2_d_datas = s103;
        wire [1:0] nds_unused_x2_d_denieds = s104;
        wire [5:0] nds_unused_x2_d_opcodes = s105;
        wire [3:0] nds_unused_x2_d_params = s106;
        wire [(TL_SINK_WIDTH * 2) - 1:0] nds_unused_x2_d_sinks = s107;
        wire [5:0] nds_unused_x2_d_sizes = s108;
        wire [(BIU_ID_WIDTH * 2) - 1:0] nds_unused_x2_d_sources = s109;
        wire [(TL_D_USER_WIDTH * 2) - 1:0] nds_unused_x2_d_users = s110;
        wire [1:0] nds_unused_x2_d_valids = s111;
        wire [1:0] nds_unused_x2_e_readys = s112;
        wire [TL_A_USER_WIDTH - 1:0] nds_unused_icu_a_user_ext = s6;
        wire [TL_C_USER_WIDTH - 1:0] nds_unused_icu_c_user_ext = s15;
        wire nds_unused_icu_c_ready = s83;
        wire nds_unused_icu_e_ready = s86;
        ...
        assign nds_unused_icu_b_address = {BIU_ADDR_WIDTH{1'b0}};
        assign nds_unused_icu_b_corrupt = 1'b0;
        assign nds_unused_icu_b_data = {BIU_DATA_WIDTH{1'b0}};
        assign nds_unused_icu_b_mask = {(BIU_DATA_WIDTH / 8){1'b0}};
        assign nds_unused_icu_b_opcode = {3{1'b0}};
        assign nds_unused_icu_b_param = {3{1'b0}};
        assign nds_unused_icu_b_size = {3{1'b0}};
        assign nds_unused_icu_b_source = {BIU_ID_WIDTH{1'b0}};
        assign nds_unused_icu_b_user = 1'b0;
        assign nds_unused_icu_b_valid = 1'b0;
        assign nds_unused_x2_b_address = {(BIU_ADDR_WIDTH * 2){1'b0}};
        assign nds_unused_x2_b_corrupt = {2{1'b0}};
        assign nds_unused_x2_b_data = {(BIU_DATA_WIDTH * 2){1'b0}};
        assign nds_unused_x2_b_mask = {(BIU_DATA_WIDTH * 2 / 8){1'b0}};
        assign nds_unused_x2_b_opcode = {6{1'b0}};
        assign nds_unused_x2_b_param = {6{1'b0}};
        assign nds_unused_x2_b_size = {6{1'b0}};
        assign nds_unused_x2_b_source = {(BIU_ID_WIDTH * 2){1'b0}};
        assign nds_unused_x2_b_user = {(TL_B_USER_WIDTH * 2){1'b0}};
...
generate
    if ((BIU_PATH_X2_INT == 1)) begin:gen_biu_x2_unused
        ...
        wire [(BIU_ID_WIDTH - 1):0] nds_unused_bid = bid;
        wire [1:0] nds_unused_bresp = bresp;
        wire nds_unused_bvalid = bvalid;
        wire [(BIU_DATA_WIDTH - 1):0] nds_unused_rdata = rdata;
        wire [(BIU_ID_WIDTH - 1):0] nds_unused_rid = rid;
        wire nds_unused_rlast = rlast;
        wire [1:0] nds_unused_rresp = rresp;
        wire nds_unused_rvalid = rvalid;
        wire nds_unused_wready = wready;
        wire [(BIU_ADDR_WIDTH * 3) - 1:0] nds_unused_x1_a_addresses = s36;
        wire [2:0] nds_unused_x1_a_corrupts = s37;
        wire [(BIU_DATA_WIDTH * 3) - 1:0] nds_unused_x1_a_datas = s38;
        wire [(BIU_DATA_WIDTH * 3 / 8) - 1:0] nds_unused_x1_a_masks = s39;
        wire [8:0] nds_unused_x1_a_opcodes = s40;
        wire [8:0] nds_unused_x1_a_params = s41;
        wire [8:0] nds_unused_x1_a_sizes = s42;
        wire [(BIU_ID_WIDTH * 3) - 1:0] nds_unused_x1_a_sources = s43;
        wire [(TL_A_USER_WIDTH * 3) - 1:0] nds_unused_x1_a_users = s44;
        wire [2:0] nds_unused_x1_a_valids = s45;
        wire [(BIU_ADDR_WIDTH * 3) - 1:0] nds_unused_x1_c_addresses = s46;
        wire [2:0] nds_unused_x1_c_corrupts = s47;
        wire [(BIU_DATA_WIDTH * 3) - 1:0] nds_unused_x1_c_datas = s48;
        wire [8:0] nds_unused_x1_c_opcodes = s49;
        wire [8:0] nds_unused_x1_c_params = s50;
        wire [8:0] nds_unused_x1_c_sizes = s51;
        wire [(BIU_ID_WIDTH * 3) - 1:0] nds_unused_x1_c_sources = s52;
        wire [(TL_C_USER_WIDTH * 3) - 1:0] nds_unused_x1_c_users = s53;
        wire [2:0] nds_unused_x1_c_valids = s54;
        wire [2:0] nds_unused_x1_d_readys = s55;
        wire [(TL_SINK_WIDTH * 3) - 1:0] nds_unused_x1_e_sinks = s56;
        wire [(TL_E_USER_WIDTH * 3) - 1:0] nds_unused_x1_e_users = s57;
        wire [2:0] nds_unused_x1_e_valids = s58;
        wire [2:0] nds_unused_x1_a_readys = s87;
        wire [2:0] nds_unused_x1_c_readys = s88;
        wire [2:0] nds_unused_x1_d_corrupts = s89;
        wire [(BIU_DATA_WIDTH * 3) - 1:0] nds_unused_x1_d_datas = s90;
        wire [2:0] nds_unused_x1_d_denieds = s91;
        wire [8:0] nds_unused_x1_d_opcodes = s92;
        wire [5:0] nds_unused_x1_d_params = s93;
        wire [(TL_SINK_WIDTH * 3) - 1:0] nds_unused_x1_d_sinks = s94;
        wire [8:0] nds_unused_x1_d_sizes = s95;
        wire [(BIU_ID_WIDTH * 3) - 1:0] nds_unused_x1_d_sources = s96;
        wire [(TL_D_USER_WIDTH * 3) - 1:0] nds_unused_x1_d_users = s97;
        wire [2:0] nds_unused_x1_d_valids = s98;
        wire [2:0] nds_unused_x1_e_readys = s99;
        wire nds_unused_icu_c_ready = s83;
        wire nds_unused_icu_e_ready = s86;
        wire nds_unused_lsu_c_ready = s26;
        wire nds_unused_lsu_e_ready = s32;
        ...
        assign nds_unused_x1_b_address = {(BIU_ADDR_WIDTH * 3){1'b0}};
        assign nds_unused_x1_b_corrupt = {3{1'b0}};
        assign nds_unused_x1_b_data = {(BIU_DATA_WIDTH * 3){1'b0}};
        assign nds_unused_x1_b_mask = {(BIU_DATA_WIDTH * 3 / 8){1'b0}};
        assign nds_unused_x1_b_opcode = {9{1'b0}};
        assign nds_unused_x1_b_param = {9{1'b0}};
        assign nds_unused_x1_b_size = {9{1'b0}};
        assign nds_unused_x1_b_source = {(BIU_ID_WIDTH * 3){1'b0}};
        assign nds_unused_x1_b_user = {(TL_B_USER_WIDTH * 3){1'b0}};
...
generate
    if ((BIU_PATH_X2_INT == 0)) begin:gen_path_x1_tlc_mux
        kv_tlc_mux #(
            ...
            .us_b_source(nds_unused_x1_b_source),
            .us_b_address(nds_unused_x1_b_address),
            .us_b_user(nds_unused_x1_b_user),
            .us_b_data(nds_unused_x1_b_data),
            .us_b_mask(nds_unused_x1_b_mask),
...
generate
    if ((BIU_PATH_X2_INT == 1)) begin:gen_path_x2_tlc_mux
        kv_tlc_mux #(
            ...
            .us_b_source(nds_unused_x2_b_source),
            .us_b_address(nds_unused_x2_b_address),
            .us_b_user(nds_unused_x2_b_user),
            .us_b_data(nds_unused_x2_b_data),
            .us_b_mask(nds_unused_x2_b_mask),
...
generate
    if ((BIU_PATH_X2_INT == 0)) begin:gen_axi_tlc2axi
        atctlc2axi500 #(
            ...
            .AFIFO_RDATA_SYNC(ASYNC_FIFO_READ_SYNC),
            ...
            .b_source(nds_unused_ds_b_source),
            .b_address(nds_unused_ds_b_address),
            .b_mask(nds_unused_ds_b_mask),
            .b_corrupt(nds_unused_ds_b_corrupt),
            .b_data(nds_unused_ds_b_data),
...
generate
    if ((BIU_PATH_X2_INT == 1)) begin:gen_path_x2_tlc2axi
        atctlc2axi500 #(
            ...
            .b_source(nds_unused_icu_b_source),
            .b_address(nds_unused_icu_b_address),
            .b_mask(nds_unused_icu_b_mask),
            .b_corrupt(nds_unused_icu_b_corrupt),
            .b_data(nds_unused_icu_b_data),
